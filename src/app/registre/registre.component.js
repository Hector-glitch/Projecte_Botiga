...
exports.RegistreComponent = void 0;
var core_1 = require("@angular/core");
var RegistreComponent = /** @class */ (function () {
    function RegistreComponent(usuariServei, router, http, firebaseAuth, config, modalService) {
    ...
    RegistreComponent.prototype.tancarSessio = function () {
        this.usuariServei.autenticat = false;
        this.autenticat = false;
        this.nomAutenticat = 'null';
    };
    RegistreComponent.prototype.onVerify = function (token) {
        this.captchaVerificat = true;
    };
    RegistreComponent.prototype.onExpired = function (response) {
        alert("La verificació ha caducat!");
    };
    RegistreComponent.prototype.onError = function (error) {
        alert("No 'ha pogut verificar correctament el captcha!");
    };
    RegistreComponent.prototype.registrar = function () {
    ...
    RegistreComponent.prototype.open = function (content) {
...
exports.RegistreComponent = RegistreComponent;
